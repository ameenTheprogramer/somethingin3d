...
function move(e){
  ...
  w2.style.clipPath = `polygon(0 0, 100% ${100 - y}px, 100% ${625 - y}px, 0% 100%)`
  if(100-x < 30){}else{
  w2.style.width = `${100  -x}px`}

  let w4 = document.getElementById('w4')
  w4.style.clipPath = `polygon(0 0, 100% ${100 - y}px, 100% ${625 - y}px, 0% 100%)`
  ...
  if(1330-x<1260){}else{
    w3.style.clipPath = `polygon(100% 0, ${1330 -x}px 100%, ${67 -x}px 100%, 0 0)`
